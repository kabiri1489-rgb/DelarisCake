...
const cakes = [
    {
        ...
        name: 'کیک شکوفه',
        price: 650000,
        desc: 'شکلات تلخ بلژیکی با خامه‌ی طبیعی و برش‌های طلایی',
        img: 'https://i.supaimg.com/d3484bf0-3568-4b4d-83d8-32004cd9b325/75612c98-f883-417e-a2e6-26ffb256e771.jpg'
    },
    {
        id: 2,
        name: 'کیک رویایی',
        ...
        img: 'https://i.supaimg.com/d3484bf0-3568-4b4d-83d8-32004cd9b325/01305b06-e1f1-45c9-b02d-98814c9fbba2.jpg'
    },
    {
        id: 3,
        name: 'کیک بامزه',
        ...
        img: 'https://i.supaimg.com/d3484bf0-3568-4b4d-83d8-32004cd9b325/eb0f40a7-4e83-425a-be88-e11c59343653.jpg'
    },
    {
        id: 4,
        name: 'کیک میوه‌ای',
    ...
    },
    {
        ...
        name: 'کیک یاس سفید',
        price: 700000,
        desc: 'طراحی مینیمال با گل یاس سفید و خامه‌ی وانیلی',
        img: 'https://i.supaimg.com/d3484bf0-3568-4b4d-83d8-32004cd9b325/0094fa55-dc95-48de-9800-c74823d8d1c2.jpg'
    }
];
...
const ideaCakes = [
    {
        ...
        name: 'کیک رمانتیک',
        price: 800000,
        desc: 'طراحی عاشقانه با گل‌های رز و خامه‌ی تمشک',
        img: 'https://i.supaimg.com/d3484bf0-3568-4b4d-83d8-32004cd9b325/fb6430b5-b573-49ee-99bf-09907c2578bc.jpg'
    },
    {
        id: 102,
        name: 'کیک توت‌فرنگی',
        price: 900000,
        desc: 'اسفنج نرم با توت‌فرنگی تازه و خامه‌ی طبیعی',
        img: 'https://i.supaimg.com/d3484bf0-3568-4b4d-83d8-32004cd9b325/750116b6-6f0c-4b8b-b2ca-1ffa0da15e21.jpg'
    }
];
...
const reviewsData = [
    {
        name: 'سارا محمدی',
        text: 'بهترین کیکی که تا حالا خوردم! طراحی و طعم فوق‌العاده بود.',
        stars: 5,
        avatar: 'https://i.pravatar.cc/100?img=1'
    },
    {
        name: 'رضا کریمی',
        text: 'ارسال سریع و بسته‌بندی بسیار لوکس. قطعاً دوباره سفارش می‌دم.',
        stars: 5,
        avatar: 'https://i.pravatar.cc/100?img=2'
    },
    {
        name: 'نرگس شیری',
        text: 'کیک تولد دخترم رو از اینجا گرفتم، همه مهمون‌ها شگفت‌زده شدن.',
        stars: 5,
        avatar: 'https://i.pravatar.cc/100?img=3'
    },
    {
        name: 'امیر حسینی',
        text: 'کیفیت مواد اولیه و طعم بی‌نظیر، واقعاً یک برند لوکس.',
        stars: 4,
